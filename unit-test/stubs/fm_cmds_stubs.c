...
CFE_Status_t FM_ConcatFilesCmd(const FM_ConcatFilesCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_ConcatFilesCmd, const FM_ConcatFilesCmd_t *, MsgPtr);
...
CFE_Status_t FM_CopyFileCmd(const FM_CopyFileCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_CopyFileCmd, const FM_CopyFileCmd_t *, MsgPtr);
...
CFE_Status_t FM_CreateDirectoryCmd(const FM_CreateDirectoryCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_CreateDirectoryCmd, const FM_CreateDirectoryCmd_t *, MsgPtr);
...
CFE_Status_t FM_DecompressFileCmd(const FM_DecompressFileCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_DecompressFileCmd, const FM_DecompressFileCmd_t *, MsgPtr);
...
CFE_Status_t FM_DeleteAllFilesCmd(const FM_DeleteAllFilesCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_DeleteAllFilesCmd, const FM_DeleteAllFilesCmd_t *, MsgPtr);
...
CFE_Status_t FM_DeleteDirectoryCmd(const FM_DeleteDirectoryCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_DeleteDirectoryCmd, const FM_DeleteDirectoryCmd_t *, MsgPtr);
...
CFE_Status_t FM_DeleteFileCmd(const FM_DeleteFileCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_DeleteFileCmd, const FM_DeleteFileCmd_t *, MsgPtr);
...
CFE_Status_t FM_GetDirListFileCmd(const FM_GetDirListFileCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_GetDirListFileCmd, const FM_GetDirListFileCmd_t *, MsgPtr);
...
CFE_Status_t FM_GetDirListPktCmd(const FM_GetDirListPktCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_GetDirListPktCmd, const FM_GetDirListPktCmd_t *, MsgPtr);
...
CFE_Status_t FM_GetFileInfoCmd(const FM_GetFileInfoCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_GetFileInfoCmd, const FM_GetFileInfoCmd_t *, MsgPtr);
...
CFE_Status_t FM_GetOpenFilesCmd(const FM_GetOpenFilesCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_GetOpenFilesCmd, const FM_GetOpenFilesCmd_t *, MsgPtr);
...
CFE_Status_t FM_MonitorFilesystemSpaceCmd(const FM_MonitorFilesystemSpaceCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_MonitorFilesystemSpaceCmd, const FM_MonitorFilesystemSpaceCmd_t *, MsgPtr);
...
CFE_Status_t FM_MoveFileCmd(const FM_MoveFileCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_MoveFileCmd, const FM_MoveFileCmd_t *, MsgPtr);
...
CFE_Status_t FM_NoopCmd(const FM_NoopCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_NoopCmd, const FM_NoopCmd_t *, MsgPtr);
...
CFE_Status_t FM_RenameFileCmd(const FM_RenameFileCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_RenameFileCmd, const FM_RenameFileCmd_t *, MsgPtr);
...
CFE_Status_t FM_ResetCountersCmd(const FM_ResetCountersCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_ResetCountersCmd, const FM_ResetCountersCmd_t *, MsgPtr);
...
CFE_Status_t FM_SetPermissionsCmd(const FM_SetPermissionsCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_SetPermissionsCmd, const FM_SetPermissionsCmd_t *, MsgPtr);
...
CFE_Status_t FM_SetTableStateCmd(const FM_SetTableStateCmd_t *MsgPtr)
{
    ...
    UT_GenStub_AddParam(FM_SetTableStateCmd, const FM_SetTableStateCmd_t *, MsgPtr);
